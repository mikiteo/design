...
HD_PWD='C:/Users/nikit/OneDrive/Desktop/bosch/design/diploma/diploma.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log xilinx_true_dual_port_no_change_1_clock_ram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source xilinx_true_dual_port_no_change_1_clock_ram.tcl
